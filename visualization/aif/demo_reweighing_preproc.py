...
class reweighing_pre:
    def Run(
        ...
        # msgtag = "demo_reweighing_preproc > Run, reweighing에서 preproc해서 나온 dataset_orig의 labels".split(
        #     ","
        # )
        # print("\n\n----------S : [{}]{}----------".format(msgtag[0], msgtag[1]))
        # print(dataset_orig.labels)
        # print("set(labels) : ", set(map(lambda x: x[0], dataset_orig.labels)))
        ...
        # copy from dataset_orig_train to dataset_transf_train
        ...
        # assert (
        #     np.abs(
        #         dataset_transf_train.instance_weights.sum()
        #         - dataset_orig_train.instance_weights.sum()
        #     )
        #     < 1e-6
        # )
        ...
        msgtag = "demo_reweighing_preproc > Run, x_train|y_train|w_train".split(",")
        print("\n\n----------S : [{}]{}----------".format(msgtag[0], msgtag[1]))
        print("x_train\n", X_train)
        print("y_train |0 1|\n", y_train, set(y_train))
        print("w_train |1|\n", w_train, set(w_train))
