    ...
    def Run_before(
        ...
        if dataset_used == "adult":
            ...
            if protected_attribute_used:
                ...
                msgtag = "demo_adversarial_debiasing > Run_before, if:preproc해서 나온 dataset_orig 바로 출력".split(
                    ","
                )
                ...
                msgtag = "demo_adversarial_debiasing > Run_before, else:preproc해서 나온 dataset_orig 바로 출력".split(
                    ","
                )
                print("\n\n----------S : [{}]{}----------".format(msgtag[0], msgtag[1]))
                print(dataset_orig)
        ...
        print(
            "Test set: Balanced classification accuracy = %f" % bal_acc_nodebiasing_test
        )
        print(
        ...
        print(
            "Test set: Theil_index = %f"
            % classified_metric_nodebiasing_test.theil_index()
        )

        # result.append(bal_acc_nodebiasing_test)
        result.append(
            classified_metric_nodebiasing_test.statistical_parity_difference()
        )
        result.append(classified_metric_nodebiasing_test.disparate_impact())
        result.append(classified_metric_nodebiasing_test.equal_opportunity_difference())
        result.append(classified_metric_nodebiasing_test.average_abs_odds_difference())
        result.append(classified_metric_nodebiasing_test.theil_index())
        result.append(bal_acc_nodebiasing_test)
        ...
        #
        # result.append(bal_acc_debiasing_test)
        # result.append(classified_metric_debiasing_test.disparate_impact())
        # result.append(classified_metric_debiasing_test.equal_opportunity_difference())
        # result.append(classified_metric_debiasing_test.average_abs_odds_difference())
        # result.append(classified_metric_debiasing_test.theil_index())
        # #
        # #     References:
    ...
    def Run_after(
        ...
        if dataset_used == "adult":
            ...
            if protected_attribute_used:
                ...
                msgtag = "demo_adversarial_debiasing > Run_after, preproc해서 나온 dataset_orig 바로 출력".split(
                    ","
                )
                print("\n\n----------S : [{}]{}----------".format(msgtag[0], msgtag[1]))
                print(dataset_orig)
        ...
        # result.append(bal_acc_debiasing_test)
        result.append(classified_metric_debiasing_test.statistical_parity_difference())
        result.append(classified_metric_debiasing_test.disparate_impact())
        result.append(classified_metric_debiasing_test.equal_opportunity_difference())
        result.append(classified_metric_debiasing_test.average_abs_odds_difference())
        result.append(classified_metric_debiasing_test.theil_index())
